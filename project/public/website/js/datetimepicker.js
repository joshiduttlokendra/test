   ...
   Plugin.prototype =
           {
              ...
              initTemplate: function ()
              {
                 ...
                 this.template = '<div class="dtp hidden" id="' + this.name + '">' +
                         ...
                         '<button class="dtp-btn-cancel btn-dark btn btn-flat  btn-sm me-2">' + this.params.cancelText + '</button>' +
                         '<button class="dtp-btn-ok btn-primary btn btn-flat btn-sm">' + this.params.okText + '</button>' +
                         '<div class="clearfix"></div>' +
                         '</div>' +
                         '</div>' +
                         '</div>';
