                                ...
                                @foreach ($allVendor as $row)
                                    ...
                                    <tr>
                                      ...
                                      <td>{{  $i++ }}</td>
                                        ...
                                        <!--<td><a href="{{ route('approve_newReview',$row->id) }}" class="btn btn-sm btn-info"><i class="fa fa-check"></i></a></td> -->

                                        <td class="text-center">
                                            <!--<a href="{{ route('approveProduct',$row->id) }}" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i></a>-->
