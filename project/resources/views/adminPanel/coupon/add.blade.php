                    ...
                    <div id="flActionButtons" class="col-lg-12">
                        <div class="statbox widget box box-shadow">
                            ...
                            <div class="widget-content widget-content-area">
                                <form class="form-vertical" action="{{ route('insertCoupon') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="form-group mb-4">
                                        <label class="control-label">Min Order Amount:</label>
                                        <input type="text" name="minOrder" class="form-control" >
                                    </div>
                                    <div class="form-group mb-4">
                                        <label class="control-label">Uses:</label>
                                        <select name="multiUses" class="form-control">
