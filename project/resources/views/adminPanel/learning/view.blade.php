                            ...
                            <table id="alter_pagination" class="table table-hover" style="width:100%">
                                ...
                                @foreach ($data as $dt)
                                    ...
                                    <tr>
                                        <td>{{  $i++ }}</td>
                                        <td>{{  $dt->title }}</td>
                                        <td><img src="{{  $dt->imageUrl }}" height="200px" width="200px"></td>
                                        <td><video src="{{  $dt->videoUrl }}" height="200px" width="200px" controls></video> </td>
                                        <td>{{  $dt->lTypeName }}</td>
                                        <td>{{  $dt->softName }}</td>
                                        <td>{{  $dt->indName }}</td>
                                        <td>@if($dt->status == 1) Active @else InActive @endif</td>
