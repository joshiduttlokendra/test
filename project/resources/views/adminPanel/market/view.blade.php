                        ...
                        <div class="table-responsive mb-4 mt-4">
                            <table id="alter_pagination" class="table table-hover" style="width:100%">
                                ...
                                @foreach ($response as $res)
                                    ...
                                    <tr>
                                        <td>{{  $i++ }}</td>
                                        <td><img src="{{asset($res->imageUrl)}}" alt="{{$res->name}}" width="100px" height="auto"/>
                                        <td><img src="{{asset($res->banner)}}" alt="{{$res->name}}" width="100px" height="auto"/>
                                        <td>{{  $res->name }}</td>
