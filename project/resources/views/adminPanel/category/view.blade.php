                            ...
                            <table id="alter_pagination" class="table table-hover" style="width:100%">
                                ...
                                @foreach ($response as $res)
                                    ...
                                    <tr>
                                        ...
                                        <td>{{  $res['name'] }}</td>
                                        <td>{{ $res['type'] }}</td>
                                        <td>@if($res['c_type'] == '1') Product @else Services @endif</td>
                                        <td>{{ $res['parent'] }}</td>
                                        <td>@if($res['imageUrl'] != null) <img src="{{ $res['imageUrl'] }}" height="100px" width="100px">@endif</td>
