    ...
    <header class="header navbar navbar-expand-sm">
        ...
        <ul class="navbar-item theme-brand flex-row  text-center">
            ...
            <li class="nav-item theme-text">
                <a href="{{route('index')}}" class="nav-link"> <img src="https://scoutin.devs.pearl-developer.com/website/img/logo.png" class="nav-logo" width="95" height="25" style=" 
                    margin-bottom: 6px;
                "> | {{Auth::user()->checkRole()}} </a>
            </li>
        </ul>
        ...
        <ul class="navbar-item flex-row ml-md-auto">
            <li class="nav-item dropdown language-dropdown" data-title="Buy Now">
                <a href="{{ url('/') }}" class="nav-link dropdown-toggle" id="language-dropdown"
                    data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" >
                    <img src="{{ asset('admin/assets/img/websiteIcon.png') }}" class="flag-width" alt="flag">
                </a>
            </li>
                                ...
                                <div class="media">
                                    <div class="user-img">
                                        <img class="usr-img rounded-circle"
                                            src="{{ asset('admin/assets/img/profile-11.jpg') }}" alt="profile">
                                    </div>
                        ...
                        <a class="dropdown-item">
                            <div class="">
                                ...
                                <div class="media">
                                    <div class="user-img">
                                        <img class="usr-img rounded-circle"
                                            src="{{ asset('admin/assets/img/profile-16.jpg') }}" alt="profile">
                                    </div>
                                    <div class="media-body">
                                        <div class="">
                        ...
                        <a class="dropdown-item">
                            <div class="">
                                ...
                                <div class="media">
                                    <div class="user-img">
                                        <img class="usr-img rounded-circle"
                                            src="{{ asset('admin/assets/img/profile-34.jpg') }}" alt="profile">
                                    </div>
                                    <div class="media-body">
                                        <div class="">
                        ...
                        <div class="dropdown-item">
                         @if(Auth::user()->roleId==1)
                            ...
                            onclick="event.preventDefault();
                             ...
                             <a class=""  href="{{ route('vendor.logout') }}"
                             onclick="event.preventDefault();
                                           document.getElementById('logout-form').submit();"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                     height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                     stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
