...
<form action="{{route('newpassword')}}" method="POST">
    @csrf
       <!-- Shipping address-->
<h2 class="h4 pt-1 pb-3 mb-3 border-bottom">Create New Password</h2>
<div class="row">
<div class="col-sm-12">
  <div class="mb-3">
    <label class="form-label" for="checkout-fn">Password</label>
    <input class="form-control" type="password" name="password" id="checkout-fn" required>
  </div>
</div>
...
<div class="col-sm-12">
  <div class="mb-3">
    ...
    <input class="form-control" type="password" name="password_confirmation" id="checkout-fn" required>
  </div>
</div>
